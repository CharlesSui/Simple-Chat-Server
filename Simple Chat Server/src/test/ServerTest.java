...
public class ServerTest {
	...
	public void testExistName(){
		...
		String[] client1Commands = {"IDEN james", "HAIL Hello from client 1"}; // add more commands in here
		client1 = new Client(9000, "localhost", client1Commands, "client1");
		client1.frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	    client1.frame.setVisible(true);
		...
		String[] testExistName = {"IDEN james", "QUIT"};//porden -- test existing name
		client5 = new Client(9000, "localhost", testExistName, "client5");
		client5.frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	    client5.frame.setVisible(true);
		...
		expect = "BAD username is already taken";
	    actual = client5.getMessage();
	...
	@Test
	public void testMulClient(){
		String[] client1Commands = {"IDEN james1", "HAIL Hello from client 1"}; // add more commands in here
		client1 = new Client(9000, "localhost", client1Commands, "client1");
		client1.frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	    client1.frame.setVisible(true);
		...
		String[] testExistName = {"IDEN james2"};//porden -- test existing name
		client5 = new Client(9000, "localhost", testExistName, "client5");
		client5.frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	    client5.frame.setVisible(true);
	    ...
	    String[] testMulClient = {"IDEN james3", "LIST", "QUIT"};//porden -- test existing name
		client12 = new Client(9000, "localhost", testMulClient, "client12");
		client12.frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	    client12.frame.setVisible(true);

	    executor.execute(client12);
	    try {
		      executor.awaitTermination(3, TimeUnit.SECONDS);
		    } catch(InterruptedException e){
		      e.printStackTrace();
		...
		expect = "OK User list: james1, james2, james3";
	    actual = client12.getMessage();
